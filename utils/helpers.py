...
def find_similar_anime(name,path_anime_weights,path_anime2anime_encoded,path_anime2anime_decoded,path_anime_df,n = 10,return_dist = False,neg= False):
...
def get_user_recommendations(similar_users , user_pref ,path_anime_df , path_synoposis_df, path_rating_df, n=10):
    ...
    if anime_list:
            ...
            for i,anime_name in enumerate(sorted_list.index):
                ...
                if isinstance(anime_name,str):
                    ...
                    synopsis = getSynopsis(int(anime_id),path_synoposis_df)
